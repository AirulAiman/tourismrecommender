...
all_tourism = pickle.load(open(Path(__file__).parents[1] / 'model/contentbased.pkl'))

cosine_sim_df = pickle.load(open(Path(__file__).parents[1] / 'model/contentbased.pkl'))
